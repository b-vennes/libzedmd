...
cp build/libcargs.dylib ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64/
cd ..
...
cp -a .libs/libserialport.{dylib,*.dylib} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64
cd ..
...
cp -a build/libsockpp.{dylib,*.dylib} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64/
cd ..
